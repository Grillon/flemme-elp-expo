...
`).map(s=>s.startsWith("- ")?`
  ...
  `}document.addEventListener("DOMContentLoaded",function(){const e=document.getElementById("app");e.innerHTML=f(h)+q(),L()});function q(){return`
